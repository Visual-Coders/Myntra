...
const Footer = () => {
  return (
    <footer className='foot'>
      <div className='Myntra'><div className="myntra-logo"></div><p className="title">Myntra</p></div>
      <div className='Mini'><div className="min-logo"></div><p className="title">Minis</p></div>
      <div className='community'><div className="comm-logo"></div><p className="title">Community</p></div>
